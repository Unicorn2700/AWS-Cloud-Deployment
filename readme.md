...
- Amazon EC2 for virtual cloud server hosting  
- Ubuntu Linux as the server operating system  
- Nginx as the web server for deployment  
- AWS Security Groups for firewall configuration  
...
**Steps performed:**
- Launched EC2 instance on AWS using Ubuntu  
- Generated and configured secure SSH key pair  
- Enabled HTTP and SSH access via security groups  
- Connected to server using SSH from local machine  
- Updated system packages and installed Nginx  
- Created and deployed a custom HTML webpage  
...
- Live website hosted on public IP  
...
- Linux server and file system management  
